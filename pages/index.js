function Home() {
  return (
    ...
    >
      ...
      <p>
        Você é o amor da minha vida e meu futuro marido. Eu te amo como nunca
        amei outro alguém. Você tem meu coração e eu nunca poderei te esquecer.
      </p>
      ...
      >
        ...
        <p>
          <i>
            <strong>Liniker, Veludo Marrom </strong>
          </i>
          🤎
        </p>
      </blockquote>
      ...
      <p>
        Se gostou da surpresa, me manda um emoji de coração marrom no Whatsapp.
        De novo, te amo muito!
      </p>

      <p style={{ "text-align": "right" }}>
        Com amor, o sempre seu, <br />
        <strong>Vini</strong>.
      </p>
    </div>
  );
